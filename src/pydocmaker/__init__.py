...
from pydocmaker.util import upload_report_to_redmine, bcolors, txtcolor, colors_dc, _raise_missing, log, remove_undefined
...
from pydocmaker.templating import (DocTemplate, TemplateDirSource, register_new_template_dir, 
                                   get_registered_template_dirs, get_available_template_ids, 
                                   test_template_exists, remove_from_template_dir, 
                                   get_template_params, resolve_template_id)
